    ...
    if (mf.is_open()){
        ...
        while (getline(mf, str)){
            ...
            if (i == 1) {
                ...
                double mn = cos1(a1,b);
                double D = a1.y*b.x- a1.x*b.y;//определяем, с какой стороны от вектора направлений лежит точка
                if ((D == 0) { /*вектора состовляют угол 180 градусов и разнонаправлены.
